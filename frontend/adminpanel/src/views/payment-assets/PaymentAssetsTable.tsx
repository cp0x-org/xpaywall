...
function stableSort(array: PaymentMethodAsset[], comparator: (a: PaymentMethodAsset, b: PaymentMethodAsset) => number) {
    ...
    <MainCard content={false}>
      <TableContainer>
        <Table sx={{ minWidth: 760 }} aria-labelledby="tableTitle">
          <PaymentAssetsTableHeader order={order} orderBy={orderBy} onRequestSort={handleRequestSort} rowCount={rows.length} />
          <TableBody>
